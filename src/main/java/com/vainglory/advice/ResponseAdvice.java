...
import com.vainglory.common.ResponseEnum;
...
@Slf4j
@RestControllerAdvice(value = "com.vainglory.controller")
public class ResponseAdvice implements ResponseBodyAdvice<Object> {
  ...
  public Object parameterExceptionHandler(MethodArgumentNotValidException e) {
    ...
    return R.F(ResponseEnum.RC400, sb.toString());
  }
