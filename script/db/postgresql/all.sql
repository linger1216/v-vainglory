...
values
  ('tenant:admin', 'Jellyfish信息科技有限公司.', '', 'lid_guan', '13800138000', null,
   '上海静安区', 'www.leegohi.com', 'plan:all', '2049-12-12 00:00:00',-1, 'tenant:admin', 1, null, null, null, 1,
...
values
  ('user:super:admin', null, '超管', 'lid_guan', '作者',
   ...
   'lid.guan@mail.com', '13816532331', '上海静安区', 1, 'tenant:admin', null, null, null, 1,
   '2024-12-12 00:00:00', '2024-12-12 00:00:00', null),
...
values('client:super:admin', 'client:super:key', 'client:super:secret', 'password,sms,social', 'pc', 2592000, -1,
       'tenant:admin', 1, null, 'user:super:admin', 'user:super:admin', 1,
       '2024-12-12 00:00:00', '2024-12-12 00:00:00', null),
